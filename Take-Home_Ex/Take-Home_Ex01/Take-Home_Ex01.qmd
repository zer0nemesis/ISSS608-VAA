...
::: callout-important
Even though we need to scroll to view the math performance of the schools, we can see there the schools generally fall into one of three categories:
...
::: callout-note
As mentioned previously, there were 47 students who did not have a socioeconomic score. These students have been ommitted to prevent distortions to the analysis.
:::
