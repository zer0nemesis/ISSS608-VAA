...
![](images/clipboard-1758350966.png){alt="In this take home exercise, we will apply newly acquired visual interactivity and visualising uncertainty methods to validate the claims presented above."}
