...
The envisaged Shiny App Dashboard for EDA is shown below:

![](images/clipboard-3010590307.png)
...
-    ***Appropriateness of analytical methods used***
    ...
    -   Relationship between two variables, supported by stats (using[**ggstatplot**](https://indrajeetpatil.github.io/ggstatsplot/articles/web_only/ggscatterstats.html) e.g. ggscatterplot, to control the confidence interval, or x and y axes)
