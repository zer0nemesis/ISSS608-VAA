...
By the end of this hands-on exercise, we will be able to create the following data visualisation by using R packages:
...
Using the code chunk below, we will install and launch the following R packages: scales, viridis, lubridate, ggthemes, gridExtra, readxl, knitr, data.table and tidyverse.
