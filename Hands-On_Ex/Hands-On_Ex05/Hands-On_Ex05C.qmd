...
Before we get started, we are to open a new Quarto document. Keep the default html as the authoring format.
...
Before we get started, we should review the [Introduction to Heatmaply](https://cran.r-project.org/web/packages/heatmaply/vignettes/heatmaply.html) to have an overall understanding of the features and functions of Heatmaply package. We are also required to have the [user manual](https://cran.r-project.org/web/packages/heatmaply/heatmaply.pdf)of the package handy for reference purposes.
